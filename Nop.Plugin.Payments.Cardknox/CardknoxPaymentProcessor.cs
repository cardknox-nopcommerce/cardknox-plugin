...
using Nop.Plugin.Payments.Cardknox.Controllers;
...
namespace Nop.Plugin.Payments.Cardknox
{
    ...
    public class CardknoxPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public ProcessPaymentResult ProcessPayment(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            if (_cardknoxPaymentSettings.TransactMode == TransactMode.Authorize)
            {
                var task = Task.Run(async () => await cardknoxFacade.AuthOnly((CardknoxSDK.Actions.AuthOnly.Request)cardknoxPaymentRequest));
                Task.WaitAll(task);
                response = task.Result;
            }
            else
            {
                var task = Task.Run(async () => await cardknoxFacade.Sale((CardknoxSDK.Actions.Sale.Request)cardknoxPaymentRequest));
                Task.WaitAll(task);
                response = task.Result;
            }
        ...
        public CapturePaymentResult Capture(CapturePaymentRequest capturePaymentRequest)
        {
            ...
            var task = Task.Run(async () => await cardknoxFacade.Capture(cardknoxRequest));
            Task.WaitAll(task);
        ...
        public RefundPaymentResult Refund(RefundPaymentRequest refundPaymentRequest)
        {
            ...
            var task = Task.Run(async () => await cardknoxFacade.Refund(cardknoxRequest));
            Task.WaitAll(task);
            var response = task.Result;
        ...
        public VoidPaymentResult Void(VoidPaymentRequest voidPaymentRequest)
        {
            ...
            var task = Task.Run(async () => await cardknoxFacade.Void(cardknoxRequest));
            Task.WaitAll(task);
            var response = task.Result;
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            controllerName = "PaymentCardknox";
            routeValues = new RouteValueDictionary { { "Namespaces", "Nop.Plugin.Payments.Cardknox.Controllers" }, { "area", null } };
        }
        ...
        {
            return typeof(PaymentCardknoxController);
        }
