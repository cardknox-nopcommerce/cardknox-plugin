...
namespace Nop.Plugin.Payments.Cardknox
{
    ...
    public class CardknoxPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Uninstall()
        {
            ...
            //locales
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.UseShippingAddressAsBilling");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.UseShippingAddressAsBilling.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.TransactModeValues");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.TransactModeValues.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.TransactionKey");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.TransactionKey.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.AdditionalFee");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.AdditionalFee.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.AdditionalFeePercentage");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.AdditionalFeePercentage.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.SoftwareName");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.SoftwareName.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.SoftwareVersion");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.SoftwareVersion.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.UseCustomSoftwareApiVersion");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.Fields.UseCustomSoftwareApiVersion.Hint");
            _localizationService.DeletePluginLocaleResource("Plugins.Payments.Cardknox.PaymentMethodDescription");
